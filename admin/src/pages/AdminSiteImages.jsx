...
const STORE_URL = (
  import.meta.env.VITE_STORE_URL || "http://localhost:5173"
).replace(/\/$/, "");
    ...
    return adminApi
      ...
      .then((res) => {
        ...
        data.processSteps = DEFAULT_PROCESS_STEPS.map((step) => {
          const match = data.processSteps?.find(
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      window.localStorage.setItem(
        "karyor:site-images:updated",
        String(Date.now()),
      );
      window.dispatchEvent(new Event("site-images-updated"));
      setSuccess("Site images saved. The store should refresh instantly.");
    } catch (err) {
      setError(err.message);
    } finally {
      setSaving(false);
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="admin-card" style={{ marginBottom: 24 }}>
          ...
          <p className="admin-hint" style={{ marginTop: -8, marginBottom: 20 }}>
            Change the top banner image separately for laptop/desktop and mobile
            screens. Upload a file from your computer or paste an image URL.
          </p>
          <ImageField
        ...
        <div className="admin-card" style={{ marginBottom: 24 }}>
          ...
          <p className="admin-hint" style={{ marginTop: -8, marginBottom: 20 }}>
            Change images for the &quot;From field to your kitchen&quot; steps
            on the home page. Upload a file or paste an image URL.
          </p>
        ...
        <div className="admin-card" style={{ marginBottom: 24 }}>
          ...
          <h3 style={{ color: "#d4af37", marginTop: 28 }}>
